...
L'application SHALL afficher une page de connexion sur la route `/login` avec : logo Cantine SEBN, champs email et mot de passe, bouton "Se connecter". En mode Development, des boutons de connexion rapide par rôle (`AdminSEBN`, `ResponsableCantine`) SHALL injecter directement le token dev sans appel API.
