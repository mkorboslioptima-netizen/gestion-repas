...
## Purpose
Permettre à l'administrateur SEBN de gérer les lecteurs biométriques Morpho Sigma Lite+ configurés dans le système : consultation, création, modification et suppression. Fournir également au service TCP la capacité de résoudre un lecteur actif à partir de son adresse IP source.
